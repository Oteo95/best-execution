...
class DDQNAgent():
    ...
    def __init__(
        ...
        self.primary_model.compile(loss="mse", optimizer=Adam(learning_rate=alpha))
        # Double Deep Q-Learning -> Add an extra model
        self.target_model = self.network()
        self.target_model.compile(loss="mse", optimizer=Adam(learning_rate=alpha))
    ...
    @staticmethod
    def getQs(s, model): # New parameter model
    ...
    def switchmodels(self):
        self.primary_model, self.target_model = self.target_model, self.primary_model
